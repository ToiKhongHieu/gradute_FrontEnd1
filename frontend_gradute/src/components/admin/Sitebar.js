                        ...
                        <ul id="iq-sidebar-toggle" className="iq-menu">
                            ...
                            <li className=" ">
                                ...
                                <ul id="product" className="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                    <li className="">
                                        <a href="/admin/ListFoods">
                                            <i className="las la-minus"></i><span>Danh sách món</span>
                                        </a>
                                    </li>
                                    <li className="">
                                        <a href="/admin/FoodsAdd">
                                            <i className="las la-minus"></i><span>Thêm món</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                                ...
                                <ul id="return" className="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                    <li className="">
                                        <a href="/admin/listvouchers">
                                            <i className="las la-minus"></i><span>Danh sách Vouchers</span>
                                        </a>
                                    </li>
                                    <li className="">
                                        <a href="/admin/voucheradd">
                                            <i className="las la-minus"></i><span>Thêm Voucher</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                                        ...
                                        <ul id="form" className="iq-submenu collapse" data-parent="#otherpage">
                                            <li className="">
                                                <a href="../backend/form-layout.html">
                                                    <i className="las la-minus"></i><span class="">Form Elements</span>
                                                </a>
                                            </li>
                                            <li className="">
                                                <a href="../backend/form-input-group.html" className="svg-icon">
                                                    <i className="las la-minus"></i><span class="">Form Input</span>
                                                </a>
                                            </li>
                                            <li className="">
                                                <a href="../backend/form-validation.html" className="svg-icon">
                                                    <i className="las la-minus"></i><span class="">Form Validation</span>
                                                </a>
                                            </li>
                                            <li className="">
                                                <a href="../backend/form-switch.html" className="svg-icon">
                                                    <i className="las la-minus"></i><span class="">Form Switch</span>
                                                </a>
                                            </li>
                                            <li className="">
                                                <a href="../backend/form-chechbox.html" className="svg-icon">
                                                    <i className="las la-minus"></i><span class="">Form Checkbox</span>
                                                </a>
                                            </li>
                                            <li className="">
                                                <a href="../backend/form-radio.html" className="svg-icon">
                                                    <i className="las la-minus"></i><span class="">Form Radio</span>
                                                </a>
                                            </li>
                                            <li className="">
                                                <a href="../backend/form-textarea.html" className="svg-icon">
                                                    <i className="las la-minus"></i><span class="">Form Textarea</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
